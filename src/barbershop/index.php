                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-md-block">
                            <h3>Tiệm cắt tóc nam số một Việt Nam</h3>
                            <p>
                                Không có người đàn ông nào xấu
                                <br>
                                 chỉ có người đàn ông chưa đến với Tung Barber
                            </p>
                        </div>
                    </div>
                    <!-- SECOND SLIDE -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="about_content" style="text-align: center;">
                        <h3>Giới Thiệu</h3>
                        <h2>Tung Barber <br>Từ 2022</h2>
                        <img src="Design/images/about-logo.png" alt="logo">
                        <p style="color: #777">
                        Phá vỡ giới hạn của một tiệm cắt tóc nam truyền thống, Tung Barber mang đến trải nghiệm cắt tóc hoàn toàn mới với chất lượng tốt nhất
                        </p>
                        <a href="#" class="default_btn" style="opacity: 1;">Tìm hiểu thêm</a>
                    </div>
                </div>
 ...
 <section class="services_section" id="services">
        <div class="container">
            <div class="section_heading">
                <h3>Top dịch vụ được yêu thích nhất</h3>
                <h2>Dịch Vụ</h2>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 padd_col_res">
                    <div class="service_box">
                        ...
                        <h3>Cắt Tóc</h3>
                        <p>Stylist sẽ trao đổi để chọn ra kiểu tóc phù hợp với gương mặt của bạn.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 padd_col_res">
                    <div class="service_box">
                        ...
                        <h3>Xả Tóc</h3>
                        <p>Stylist sẽ xả sạch tóc con để đảm bảo sự hoàn hảo cho mái tóc của bạn.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 padd_col_res" >
                    <div class="service_box">
                        ...
                        <h3>Massage</h3>
                        <p>Massage luôn là cách thư giãn tuyệt vời sau những mệt mỏi của bạn.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 padd_col_res">
                    <div class="service_box">
                        ...
                        <h3>Tạo Kiểu</h3>
                        <p>Stylist giúp bạn cách vuốt gôm sáp để mái tóc đẹp chuẩn phong cách.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="book_section" id="booking">
                ...
                <div class="col-md-6 offset-md-6">
                    <form action="appointment.php" method="post" id="appointment_form" class="form-horizontal appointment_form">
                        <div class="book_content">
                            <h2 style="color: white;">Đặt Lịch Ngay</h2>
                            <p style="color: #999;">
                            Phá vỡ giới hạn của một tiệm cắt tóc nam truyền thống <br> Tung Barber mang đến trải nghiệm cắt tóc hoàn toàn mới với chất lượng tốt nhất
                            </p>
                        </div>
     ...
     <section class="gallery-section" id="gallery">
        <div class="section_heading">
            <h3>Top kiểu tóc được yêu thích nhất</h3>
            <h2>Bộ sưu tập</h2>
            <div class="heading-line"></div>
        </div>
        <div class="container">
     ...
     <section id="team" class="team_section">
        <div class="container">
            <div class="section_heading ">
                <h3>Top Stylist được yêu thích nhất</h3>
                <h2>Stylist</h2>
                <div class="heading-line"></div>
            </div>
...
<div class="container">
    <div class="section_heading">
        <h3>Ưu đãi 10% với khách hàng đặt lịch trước</h3>
                                    ...
                                    foreach($services as $service)
                                    {
                                        ?>
                                            ...
                                            <li>
                                                ...
                                                <span class="price"><?php echo $service['service_price'] ?>đ</span>
                                            </li>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        <h2>
                        Liên hệ và gửi tin nhắn
                            <br>cho chúng tôi ngày hôm nay!
                        </h2>
                        <br>
                        <h3>
                            Trụ sở chính:
                            <br>
                            <br> 176 Trương Định - Hai Bà Trưng - Hà Nội
                ...
                <div class="col-lg-6 sm-padding">
                    <div class="contact-form">
                        <div id="contact_ajax_form" class="contactForm">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <input type="text" id="contact_subject" name="subject" class="form-control" placeholder="Nghề nghiệp">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <textarea id="contact_message" name="message" cols="30" rows="5" class="form-control message" placeholder="Nội dung"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <button id="contact_send" class="default_btn">Gửi</button>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                     <div class="footer_widget">
                        <h3>Trụ sở chính</h3>
                        <p>
                            176 Trương Định - Hai Bà Trưng - Hà Nội
                        </p>
                        <p>
                            xtung99@gmail.com
                            <br>
