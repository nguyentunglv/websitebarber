		...
		<div class="login">
			<form class="login-container validate-form" name="login-form" method="POST" action="login.php" onsubmit="return validateLogInForm()">
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_username">Bắt buộc</span>
				</div>
				...
				<div class="form-input">
					...
					<span class="invalid-feedback" id="required_password">Bắt buộc</span>
				</div>
				
				<!-- SIGN IN BUTTON -->

				<p>
					<button type="submit" name="signin-button" >Đăng nhập</button>
				</p>

				<!-- FORGOT YOUR PASSWORD LINK -->

				<span class="forgotPW">Quên mật khẩu ? <a href="#">Tìm lại</a></span>
			</form>
		</div>
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
		  		<div class="copyright text-center my-auto">
					<span> Barbershop Website by XUAN TUNG</span>
		  		</div>
			</div>
	  	</footer>
		<!-- End of Footer -->
