...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Lịch cắt của Stylist</h1>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Lịch của Stylist</h6>
                </div>
                <div class="card-body">
                    <div class="sb-entity-selector" style="max-width:300px;">
                        <form action="employees-schedule.php" method="POST">
                            <div class="form-group">
                                ...
                                <button type="submit" name="show_schedule_sbmt" class="btn btn-primary">Kiểm tra</button>
                            </div>
                        </form>
                    </div>
                    
                    <div class="alert alert-info">
                        Chọn thời gian bắt đầu và thời gian kết thúc để thiết lập giờ làm việc.
                    </div>
                    ...
                    <div class="sb-content" style="min-height: 500px;">
                        ...
                        ?>
                                <form method="POST" action="employees-schedule.php">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="save_schedule_sbmt" class="btn btn-info">Lưu</button>
                                    </div>
                                </form>
                        <?php
                            }
                        ...
                        if(isset($_POST['save_schedule_sbmt']))
                        {
                            ...
                            foreach($days as $key=>$value)
                            {
                                ...
                                {   
                                    ...
                                    $message = "Cập nhập lịch nhân viên thành công";
                                    
                                    ?>

                                        <script type="text/javascript">
                                            swal("Đăng ký","Đăng ký lịch cho nhân viên thành công!", "success").then((value) => {}); 
                                        </script>
