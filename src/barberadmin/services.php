                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                Bạn muốn xóa dịch vụ "<?php echo $service['service_name']; ?>"?
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Hủy</button>
                                                                                <button type="button" data-id = "<?php echo $service['service_id']; ?>" class="btn btn-danger delete_service_bttn">Xóa</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="services.php?do=Add">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['service_name']))?htmlspecialchars($_POST['service_name']):'' ?>" placeholder="Tên dịch vụ" name="service_name">
                                            <?php
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                        <div class="form-group">
                                            <label for="service_category">Loại dịch vụ</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="service_duration">Thời gian(phút)</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['service_duration']))?htmlspecialchars($_POST['service_duration']):'' ?>" placeholder="Thời gian" name="service_duration">
                                            <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['service_price']))?htmlspecialchars($_POST['service_price']):'' ?>" placeholder="Giá" name="service_price">
                                            <?php
                                ...
                                <button type="submit" name="add_new_service" class="btn btn-primary">Thêm</button>
                                    ...
                                    try
                                    {
                                        ...
                                        ?> 
                                            ...
                                            <script type="text/javascript">
                                                swal("Dịch vụ mới","Dịch vụ mới đã được thêm thành công", "success").then((value) => 
                                                {
                                    ...
                                    <form method="POST" action="services.php?do=Edit&service_id=<?php echo $service_id; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="service_name">Tên dịch vụ</label>
                                                    <input type="text" class="form-control" value="<?php echo $service['service_name'] ?>" placeholder="Tên dịch vụ" name="service_name">
                                                    <?php
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="service_duration">Thời gian(min)</label>
                                                    <input type="text" class="form-control" value="<?php echo $service['service_duration'] ?>" placeholder="Thời gian" name="service_duration">
                                                    <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="service_price">Giá dịch vụ</label>
                                                    <input type="text" class="form-control" value="<?php echo $service['service_price'] ?>" placeholder="Giá" name="service_price">
                                                    <?php
                                        ...
                                        <!-- SUBMIT BUTTON -->
                                        <button type="submit" name="edit_service_sbmt" class="btn btn-primary">Lưu</button>
                                    </form>
                                        ...
                                        if(isset($_POST['edit_service_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_service_form == 0)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                ?> 
                                                    ...
                                                    <script type="text/javascript">
                                                        swal("Cập nhập dịch vụ","Dịch vụ đã được xóa thành công", "success").then((value) => 
                                                        {
                                                            window.location.replace("services.php");
                                                        });
                                                    </script>
