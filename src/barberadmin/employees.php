                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="button" data-id = "<?php echo $employee['employee_id']; ?>" class="btn btn-danger delete_employee_bttn">Xóa</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="employees.php?do=Add">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_fname">Họ</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_fname']))?htmlspecialchars($_POST['employee_fname']):'' ?>" placeholder="Họ" name="employee_fname">
                                            <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_lname">Tên</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_lname']))?htmlspecialchars($_POST['employee_lname']):'' ?>" placeholder="Tên" name="employee_lname">
                                            <?php
                                                if(isset($_POST['add_new_employee']))
                                                {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_phone']))?htmlspecialchars($_POST['employee_phone']):'' ?>" placeholder="Số điện thoại" name="employee_phone">
                                            <?php
                                                if(isset($_POST['add_new_employee']))
                                                {
                                ...
                                <button type="submit" name="add_new_employee" class="btn btn-primary">Thêm</button>
                                    ...
                                    <form method="POST" action="employees.php?do=Edit&employee_id=<?php echo $employee_id; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_fname">Họ</label>
                                                    <input type="text" class="form-control" value="<?php echo $employee['first_name'] ?>" placeholder="Họ" name="employee_fname">
                                                    <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_lname">Tên</label>
                                                    <input type="text" class="form-control" value="<?php echo $employee['last_name'] ?>" placeholder="Tên" name="employee_lname">
                                                    <?php
                                                        if(isset($_POST['edit_employee_sbmt']))
                                                        {
                                                            if(empty(test_input($_POST['employee_lname'])))
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_phone">Số điện thoại</label>
                                                    <input type="text" class="form-control" value="<?php echo $employee['phone_number'] ?>"  placeholder="Số điện thoại" name="employee_phone">
                                                    <?php
                                                        if(isset($_POST['edit_employee_sbmt']))
                                                        {
                                                            if(empty(test_input($_POST['employee_phone'])))
                                        ...
                                        if(isset($_POST['edit_employee_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_employee_form == 0)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                ?> 
                                                    ...
                                                    <script type="text/javascript">
                                                        swal("Nhân viên","Nhân viên đã cập nhập thành công", "success").then((value) => 
                                                        {
                                                            window.location.replace("employees.php");
                                                        });
                                                    </script>
